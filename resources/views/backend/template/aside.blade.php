<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="#" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">{{ Auth::user()->roles }}</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        @if (Auth::user()->roles == 'admin')
            ...
            {{-- kusioner --}}
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Kusioner</span>
            </li>
            ...
            <li class="menu-item {{ request()->is('admin/pertanyaan*') ? 'active' : '' }}">
            ...
            <li class="menu-item {{ request()->is('admin/mitra*') ? 'active' : '' }}">
                <a href="{{ route('admin.mitra.index') }}" class="menu-link">
                    <i class='menu-icon tf-icons bx bxs-user-circle'></i>
                    <div data-i18n="Analytics">Mitra</div>
                </a>
            </li>

            <li class="menu-item {{ request()->is('admin/pelajar*') ? 'active' : '' }}">
                <a href="{{ route('admin.pelajar.index') }}" class="menu-link">
                    <i class='menu-icon tf-icons bx bxs-user-circle'></i>
                    <div data-i18n="Analytics">Pelajar</div>
                </a>
            </li>
            {{-- end Akun --}}
            ...
            {{-- analisis kinerja --}}
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">analisis kinerja</span>
            </li>
            <li class="menu-item {{ request()->is('admin/kinerja-mitra*') ? 'active' : '' }}">
                <a href="{{ route('admin.kinerja-mitra.index') }}" class="menu-link">
                    <i class='menu-icon bx bxs-receipt'></i>
                    <div data-i18n="Analytics">Mitra</div>
                </a>
            </li>
            {{-- end analisis kinerja --}}
        @elseif (Auth::user()->roles == 'pelajar')
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Data</span>
            </li>
            <li class="menu-item {{ request()->is('pelajar*') ? 'active' : '' }}">
                <a href="{{ route('pelajar.kusioner.index') }}" class="menu-link">
                    <i class='menu-icon tf-icons bx bxs-data'></i>
                    <div data-i18n="Analytics">Kusioner</div>
                </a>
            </li>
        @else
            <!-- Dashboard -->
            <li class="menu-item {{ request()->is('mitra/dashboard*') ? 'active' : '' }}">
            ...
            <li class="menu-item {{ request()->is('mitra/kegiatan*') ? 'active' : '' }}">
                <a href="{{ route('mitra.kegiatan.index') }}" class="menu-link">
                    <i class='menu-icon tf-icons bx bxs-data'></i>
                    <div data-i18n="Analytics">Kegiatan</div>
                </a>
            </li>
            ...
            <li class="menu-item {{ request()->is('mitra/presensi*') ? 'active' : '' }}">
                <a href="{{ route('mitra.presensi.index') }}" class="menu-link">
                    <i class='menu-icon bx bxs-receipt'></i>
                    <div data-i18n="Analytics">Presensi</div>
                </a>
            </li> --}}
